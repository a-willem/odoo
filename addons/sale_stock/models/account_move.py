...
class AccountMove(models.Model):
    ...
    def _get_invoiced_lot_values(self):
        ...
        self_datetime = max(self.invoice_line_ids.filtered(lambda i: not i.display_type == 'line_note').mapped('write_date')) if self.invoice_line_ids else None
        last_invoice_datetime = max(last_invoice.invoice_line_ids.filtered(lambda i: not i.display_type == 'line_note').mapped('write_date')) if last_invoice else None
